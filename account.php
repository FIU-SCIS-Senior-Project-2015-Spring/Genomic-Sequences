...
<head>
	<title>Genome Pro</title>
		...
		<script src="JSFiles/accountControllers.js"></script>

	        <!--graph library-->
                <link href="StyleFiles/graph.css" rel="stylesheet">
                <script src="JSFiles/d3.min.js"></script>                
                <script src="JSFiles/angular-charts.min.js"></script>
...
<body>
	...
	<script src="JSFiles/bootstrap.js"></script>
        <img src="Images/ajax-loader.gif" id="loading-indicator" style="display:none" /> <!--this is the loader in tools page-->
</body>
</html>
